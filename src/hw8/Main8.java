...
//        HashTable<Product, Integer> hashTable = new HashTableImpl<>(5);//5 * 2 = 10
        ...
        hashTable.put(new Product(7, "Watermelon"), 228); //7 -> 8
        hashTable.put(new Product(18, "Cherry"), 250); //0
        hashTable.put(new Product(14, "Beer"), 120); //1 -> 2
        hashTable.put(new Product(32, "Chips"), 67);
